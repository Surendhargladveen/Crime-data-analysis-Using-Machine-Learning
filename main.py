...
victims = pd.read_csv('C:/Users/DELL/OneDrive/Desktop/CRIMEANALYSIS/crime/20_Victims_of_rape.csv')
police_hr = pd.read_csv('C:/Users/DELL/OneDrive/Desktop/CRIMEANALYSIS/crime/35_Human_rights_violation_by_police.csv')
auto_theft = pd.read_csv('C:/Users/DELL/OneDrive/Desktop/CRIMEANALYSIS/crime/30_Auto_theft.csv')
prop_theft = pd.read_csv('C:/Users/DELL/OneDrive/Desktop/CRIMEANALYSIS/crime/10_Property_stolen_and_recovered.csv')
...
for item in my_list:
  if item in input.lower():
    if item == 'rape'or item == 'harassment' :
        ...
        shp_gdf = gpd.read_file('C:/Users/DELL/OneDrive/Desktop/CRIMEANALYSIS/map/India States/Indian_states.shp')
        ...
        df = pd.read_csv('C:/Users/DELL/OneDrive/Desktop/CRIMEANALYSIS/crime/10_Property_stolen_and_recovered.csv')
        stats = df.describe()
        st.write(stats)
        ...
        murder = pd.read_csv("C:/Users/DELL/OneDrive/Desktop/CRIMEANALYSIS/crime/32_Murder_victim_age_sex.csv")
